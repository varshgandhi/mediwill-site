  ...
  return (
    <main>
      ...
      <ProductSection 
        ...
        subtitle="Precision Cardiac Care." 
        tagline="Better Outcomes." 
        theme="cardiac" 
        imageAlt="Cardiac care visualization" 
      />
      ...
      <section id="contact" style={{
        ...
        <h2 style={{ fontSize: "48px", marginBottom: "20px", textAlign: "center" }}>Let's Connect</h2>
